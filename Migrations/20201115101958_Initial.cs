        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bugs_SubCategories_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BugCommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BugComments", x => x.BugCommentId);
                    table.ForeignKey(
